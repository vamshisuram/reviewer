...
class BaseSelector extends prompts.PromptMixin {
...
const defaultSingleSelectPrompt = new prompts.PromptTemplate({
    templateVars: [
        "context",
        "query",
        "numChoices"
...
const defaultMultiSelectPrompt = new prompts.PromptTemplate({
    templateVars: [
        "contextList",
        "query",
        "maxOutputs",
 ...
 */ class LLMMultiSelector extends BaseSelector {
   ...
   */ async _select(choices, query) {
        ...
        const prompt = this.prompt.format({
            ...
            query: utils.extractText(query.query),
...
exports.LLMMultiSelector = LLMMultiSelector;
exports.LLMSingleSelector = LLMSingleSelector;
exports.getSelectorFromContext = getSelectorFromContext;
